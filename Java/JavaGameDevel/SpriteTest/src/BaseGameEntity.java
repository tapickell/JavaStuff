...
public class BaseGameEntity extends Object
{
	...
	public void incVelX(double iv) { this.velX += iv; }
	public void setVelY(double velY) { this.velY = velY; }
	public void incVelY(double iv) { this.velY += iv; }
	public void setFaceAngle(double angle) { this.faceAngle = angle; }
	public void incFaceAngle(double ia) { this.faceAngle += ia; }
	public void setMoveAngle(double angle) { this.moveAngle = angle; }
	public void incMoveAngle(double ia) { this.moveAngle += ia; }
